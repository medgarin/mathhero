...
export default function QuestionCard({ a, b, timeLeft, totalTime }: QuestionCardProps) {
    ...
    return (
        <div className="relative w-full max-w-2xl bg-white dark:bg-zinc-900 rounde-custom-xl shadow-2xl shadow-zinc-200/50 dark:shadow-none border border-zinc-100 dark:border-zinc-800 p-12 flex flex-col items-center text-center">
            {/* Timer Indicator */}
            ...
            <div className="space-y-4">
                <p className="text-zinc-400 dark:text-zinc-500 font-medium text-lg tracking-[0.2em] mt-4">Calcula el resultado</p>
                <h2 className="text-5xl md:text-8xl font-black text-zinc-900 dark:text-white tracking-tighter">
